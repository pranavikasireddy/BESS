...
def apply_grid_transport_cost(net_revenue_eur: float, dispatch: pd.DataFrame, config: dict) -> float:
    ...
    days_covered = (dispatch.index[-1] - dispatch.index[0]).total_seconds() / 86400 + 1
